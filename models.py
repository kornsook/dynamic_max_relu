...
def create_dense_model(input_shape, location="end", init_max_val = 100, activation = "mrelu"):
...
def create_shallow_cnn_model(input_shape, location="end", init_max_val = 100, activation = "mrelu"):
    model = tf.keras.Sequential()
...
def create_vgg16_model(input_shape, location = "end", init_max_val = 100, activation = "mrelu"):
    model = tf.keras.Sequential()
    if(location == "beginning"):
        model.add(Conv2D(filters=input_shape[2], kernel_size=(3, 3), input_shape = input_shape, padding="same"))
        if(activation == "mrelu"):
...
def create_resnet50_model(input_shape, location = "end", init_max_val = 100, activation = "mrelu"):
    model = tf.keras.Sequential()
    if(location == "beginning"):
        model.add(Conv2D(filters=input_shape[2], kernel_size=(3, 3), input_shape = input_shape, padding="same"))
        if(activation == "mrelu"):
...
def create_resnet101_model(input_shape, location = "end", init_max_val = 100, activation = "mrelu"):
    model = tf.keras.Sequential()
    if(location == "beginning"):
        model.add(Conv2D(filters=input_shape[2], kernel_size=(3, 3), input_shape = input_shape, padding="same"))
        if(activation == "mrelu"):
...
def create_mobilenetv2_model(input_shape, location = "end", init_max_val = 100, activation = "mrelu"):
    model = tf.keras.Sequential()
    if(location == "beginning"):
        model.add(Conv2D(filters=input_shape[2], kernel_size=(3, 3), input_shape = input_shape, padding="same"))
        if(activation == "mrelu"):
...
def create_inceptionv3_model(input_shape, location = "end", init_max_val = 100, activation = "mrelu"):
    model = tf.keras.Sequential()
    if(location == "beginning"):
        model.add(Conv2D(filters=input_shape[2], kernel_size=(3, 3), input_shape = input_shape, padding="same"))
        if(activation == "mrelu"):
